...
async function main() {
    const http = new index_js_1.UpDownHttpClient(base);
    ...
    const wss = (0, index_js_1.wsUrlFromHttpBase)(base);
    const ws = new index_js_1.UpDownWsClient(wss, (msg) => {
        if (msg.type === "orderbook_update")
            console.log("book", msg.channel);
    });
